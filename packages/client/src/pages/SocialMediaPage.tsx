...
const SocialMediaPage: React.FC = () => {
  ...
  const socialPlatforms = [
    {
      ...
      url: 'https://facebook.com/ThePalaceSchool',
      icon: 'facebook',
      followers: '2.5K',
    ...
    },
    {
      name: 'Instagram',
      handle: '@thepalaceschool',
      url: 'https://instagram.com/thepalaceschool',
      icon: 'instagram',
      followers: '3.2K',
    ...
    {
      name: 'Twitter',
      handle: '@PalaceSchool_',
      url: 'https://twitter.com/PalaceSchool_',
      icon: 'twitter',
      followers: '1.8K',
    ...
    {
      name: 'LinkedIn',
      handle: 'The Palace School',
      url: 'https://linkedin.com/company/the-palace-school',
      icon: 'linkedin',
      followers: '950',
    ...
    {
      name: 'YouTube',
      handle: 'The Palace School Official',
      url: 'https://youtube.com/@ThePalaceSchool',
      icon: 'youtube',
      followers: '1.2K',
      description: 'Watch school events, student performances, and educational content',
      color: 'bg-red-600'
    },
    {
      name: 'WhatsApp',
      ...
      icon: 'whatsapp',
      followers: '500+',
      description: 'Quick communication channel for parents and students',
      color: 'bg-green-500'
    }
  ];
  ...
  const recentPosts = [
    {
      platform: 'Instagram',
      content: 'Amazing science fair projects by our students! 🧪✨',
    ...
    {
      platform: 'Facebook',
      content: 'Congratulations to our debate team for winning the regional championship! 🏆',
      image: '/api/placeholder/400/300',
      likes: '89',
      date: '5 hours ago'
    },
    {
      platform: 'Twitter',
      content: 'Exciting news: New computer lab opening next month! 💻',
      image: '/api/placeholder/400/300',
      likes: '45',
      date: '1 day ago'
    }
